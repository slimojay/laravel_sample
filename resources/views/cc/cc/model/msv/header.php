...
$app->authenticate($_SESSION['user']);
...
<link rel='icon' href='../img/mojlogo.png'>
    ...
    <nav class="navbar blue-bg navbar-static-top"> 
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <!--<img src="dist/img/img1.jpg" class="user-image" alt="User Image">--> <i class='fa fa-user' black></i> <span class="hidden-xs"><?php echo ucwords($_SESSION['user']); ?></span> </a>
            <ul class="dropdown-menu">
              ...
              <li role="separator" class="divider"></li>
              <li><a href="../logout"><i class="fa fa-external-link" aria-hidden="true"></i> Logout</a></li>
            </ul>
          </li>
        </ul>
      </div>
