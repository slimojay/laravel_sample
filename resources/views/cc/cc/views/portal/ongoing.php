...
?>
 ...
 <!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper"> 
    ...
    <caption><h3 class='text-info-20'><strong>List of Ongoing Matters</strong></h3></caption>
    <table id="display" class='table table-stripped table-hover table-bordered' border='1px' style='padding:1px; text-transform:capitalize'>
        ...
        <tbody>
            <?php if ($_SERVER['REQUEST_METHOD'] == 'GET'){
                ...
                echo $app->fetchOngoingCase($_SESSION['center'], $_SESSION['concern'], null);}else{
            echo $app->fetchOngoingCase(null, $_SESSION['concern'], null);
            }
